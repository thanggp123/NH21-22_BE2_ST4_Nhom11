			...
			<div class="col col-md-12">
				...
				<div class="row">
					<div class="col-md-6 text-left">
						<a href="{{ url('/') }}" class="btn btn-warning btn-md"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp;Thoát</a>
						<a href="{{ url('/checkout') }}" class="btn btn-primary btn-md"><i class="fa fa-shopping-cart" aria-hidden="true"></i>&nbsp;Thanh Toán</a>
					</div>
					<div class="col-md-6 text-right" >
						<h3>Thành Tiền: <strong style="color: crimson">{{ number_format($total).' VNĐ ' }}</strong></3>
					</div>
				</div>
			</div>
		</div>
