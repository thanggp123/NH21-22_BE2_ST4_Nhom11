	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-5 order-details">
								...
								<div class="order-col">
									...
									<div>
										<?php if ($value->sale > 0) {
											...
											echo number_format(($value->price - ($value->price * $value->sale / 100)) * session()->get('carts' . $value->product_id)) . " VNĐ ";
										} else {
				...
				<?php if ($user != NULL) { ?>
					<a href="{{ url('/index') }}" class="primary-btn order-submit">Place order</a>
				<?php } else { ?>
